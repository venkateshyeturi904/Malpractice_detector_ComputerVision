...
class Window(QWidget):
    def __init__(self):
        ...
        pixmap2 = pixmap21.scaled(w*0.30,h*0.425)
        label2.setPixmap(pixmap2)
        self.resize(pixmap2.width(),pixmap2.height())
        label2.setGeometry(w*0.15625,h*0.2685,pixmap2.width(),pixmap2.height())
        self.create_widgets()
    ...
    def create_widgets(self):
        ...
        btn1.setGeometry(w*0.677,h*0.6481,w*0.11979,h*0.0416)
        btn2 = QPushButton("Admin Login",self)
        btn2.setGeometry(w*0.5208,h*0.6481,w*0.11979,h*0.0416)

        self.label = QLabel("Exam proctoring system, IIT Guwahati",self)
        self.label.move(w*0.2796,h*0.055)
        self.label.setFont(QFont("Algerian",w*h*0.0000120))
        self.label.setStyleSheet("color : white")
        

        self.label4 = QLabel("Welcome to Exam Proctoring System, IIT Guwahati",self)
        self.label4.setStyleSheet("color : white")
        self.label4.move(w*0.3109,h*0.1296)
        self.label4.setFont(QFont("",w*h*0.000007716))
        ...
        self.label5.move(w*0.27083,h*0.1620)
        self.label5.setFont(QFont("",w*h*0.000007716))
        
        self.textbox1 = QLineEdit(self)
        #self.textbox1.setTextMargins(1,1,1,30)
        self.textbox1.setFont(QFont("",w*h*0.0000062692))
        self.textbox2 = QLineEdit(self)
        self.textbox2.setFont(QFont("",w*h*0.0000062692))
        self.textbox1.move(w*0.5208,h*0.3240)
        self.textbox2.move(w*0.5208,h*0.4166)
        self.textbox1.resize(w*0.2760,h*0.04166)
        self.textbox2.resize(w*0.2760,h*0.04166)

        self.label2 = QLabel("UserName",self)
        self.label2.move(w*5208,h*0.2842)
        self.label2.setFont(QFont("Times New Roman",17))
        self.label2.setStyleSheet("color:white")

        self.label3 = QLabel("Password",self)
        self.label3.move(w*5208,h*0.3768)
        ...
        label7.setGeometry(int(w*0.75),h*0.50925,w*0.09375,h*0.0444)  
